...
def exp_gradual_mix(dataset, diff_dataset, n_samples=3000, seed=DEFAULT_SEED):
    ...
    if n_samples > 0:
        ...
        sampled_idxs, _ = train_test_split(orig_idxs, train_size=(X_inter_1.shape[0] - n_samples), random_state=seed)
    ...
    if n_samples > 0:
        ...
        sampled_idxs, _ = train_test_split(orig_idxs, train_size=(X_inter_2.shape[0] - n_samples), random_state=seed)
...
def main(**kwargs):
    ...
    for i, seed in enumerate(seeds):
        ...
        for model_name in model_names:
            ...
            elif model == 'gradualMix':
                exp_f = exp_gradual_mix
            ...
            with open(f'./log_bases{seeds[0]}.log', 'a') as fh:
    ...
    with open(f'./results/adapt_results_bases{seeds[0]}.pkl', 'wb') as fh:
    ...
    with open(f'./results/adapt_results_bases{seeds[0]}.csv', 'w') as file:
